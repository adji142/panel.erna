...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('login/go_reset');?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="" name="res_acv" value="<?php echo $this->session->userdata('param_email'); ?>" readonly>
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Retype New password" name="re_new">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="row">
        <!-- /.col -->

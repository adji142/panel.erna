...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Feb 2018 pada 06.34
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
INSERT INTO `app_menu` (`id`, `Name`, `Logo`, `Link`, `level`, `level2`) VALUES
(1, 'Dashboard', 'fa-dashboard', 'back/dashboard/', 1, 2),
(2, 'Profile', 'fa-user', 'back/dashboard/profile', 1, 2),
(3, 'Feedback', 'fa-feed', '', 1, 1),
(4, 'Store performance', 'fa-thumbs-o-up', '', 1, 1),
(5, 'Store Promo', 'fa-cart-plus', 'back/dashboard/post', 1, 1),
(6, 'Promo', 'fa-cart-arrow-down', 'back/dashboard/ongoing', 1, 1),
(8, 'My Account', 'fa-gears', 'back/dashboard/account', 1, 2),
(9, 'Change Password', 'fa-lock', 'login/reset', 1, 2),
(10, 'Towo Feedback', 'fa-feed', '', 2, 2),
(11, 'Towo Perform', 'fa-thumbs-o-up', '', 2, 2),
(12, 'Towo User ', 'fa-users', '', 2, 2),
(13, 'Towo User Block', 'fa-user-times', '', 2, 2),
(14, 'Towo Report', 'fa-bar-chart', '', 2, 2),
(15, 'Towo Menu', 'fa-bars', '', 2, 2),
(16, 'Towo Event', 'fa-tv', '', 2, 2);

-- --------------------------------------------------------

--
-- Struktur dari tabel `app_post`
--
...
--
-- Dumping data untuk tabel `app_post`
--
...
(26077, '781066894', 'this is chek for (edit)', 'this is chek for new post #for #insert #tag (edited) ', '2017-10-07 14:56:37', '2017-11-11', '2017-11-13', 'expired', 'for,insert,tag', 'img_post/781066894/profile.png', 'img_post/781066894/images5.png', 'img_post/781066894/203120714.png', 'img_post/781066894/0', 'img_post/781066894/0'),
...
--
-- Struktur dari tabel `app_profile`
--
...
--
-- Dumping data untuk tabel `app_profile`
--
...
--
CREATE TABLE IF NOT EXISTS `log_login_view` (
`id_reg` int(50)
,`datetime` datetime
,`browser` varchar(150)
,`OS` varchar(50)
...
--
-- Struktur dari tabel `social_user`
--
...
--
-- Dumping data untuk tabel `social_user`
--
...
--
-- Dumping data untuk tabel `storetype`
--

INSERT INTO `storetype` (`id`, `storetype`, `class`, `parent`) VALUES
(1, 'None', 'fa fa-pie-chart', 'non'),
(2, 'Departement store', 'fa fa-bank', 'dep'),
(3, 'Customer good', 'fa fa-wheelchair', 'cus'),
(4, 'Minimarket', 'fa fa-shield', 'min'),
(5, 'Whole Sale', 'fa fa-home', 'whl'),
(6, 'Supermarket', 'fa fa-shield', 'spr'),
(7, 'Factory Outlet', 'fa fa-asterisk', 'fot'),
(8, 'Distro', 'fa fa-at', 'dis'),
(9, 'Food Center', 'fa fa-utensils', 'foo'),
(10, 'Hotels', 'fa fa-hotel', 'htl'),
(11, 'Travel', 'fa fa-suitcase', 'tra'),
(12, 'Electronic', 'fa fa-desktop', 'ele'),
(13, 'Book and office', 'fa fa-book', 'bof'),
(14, 'Education', 'fa fa-bookmark-o', 'edu');
...
--
-- Dumping data untuk tabel `ver_code`
--
...
--
-- Struktur dari tabel `view_like_post`
--

CREATE TABLE IF NOT EXISTS `view_like_post` (
`id` int(11) NOT NULL,
  `id_reg` varchar(50) NOT NULL,
  `id_post` int(15) NOT NULL,
...
--
-- Dumping data untuk tabel `view_like_post`
--

INSERT INTO `view_like_post` (`id`, `id_reg`, `id_post`, `view`, `like`, `date_time`) VALUES
(1, '781066894', 6765, 11, 0, '2018-01-24 00:00:00'),
(2, '781066894', 6765, 1, 1, '2018-01-24 00:00:00');

-- --------------------------------------------------------

--
-- Struktur untuk view `log_login_view`
--
...
ALTER TABLE `app_profile`
 ADD PRIMARY KEY (`id_reg`), ADD UNIQUE KEY `id_profile` (`id_profile`);
...
--
-- AUTO_INCREMENT for table `view_like_post`
--
ALTER TABLE `view_like_post`
